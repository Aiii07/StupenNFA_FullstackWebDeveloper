        ...
        <div className="max-w-2xl px-4 py-8 mx-auto lg:py-16">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                type="reset"
                className="text-grey-600 inline-flex items-center hover:text-white border bordergrey-600 hover:bggrey-600 focus:ring-4 focus:outline-none focus:ringgrey-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bordergrey-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900"
              >
                Reset
              </button>
            </div>
